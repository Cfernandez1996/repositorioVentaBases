        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            using (var connection = new NpgsqlConnection(cadenaConexion))
            {
                try
                {
                    ...
                    using (var cmd = new NpgsqlCommand("public.modificar_producto", connection))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;

                        // Agregar los parámetros necesarios
                        cmd.Parameters.AddWithValue("p_upc", upc);
                        ...
                        cmd.Parameters.AddWithValue("p_embalaje", embalaje);
                        ...
                        cmd.Parameters.AddWithValue("p_reorden", reorden);
